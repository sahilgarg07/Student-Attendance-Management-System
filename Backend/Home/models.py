...
class session_record_table(models.Model):
    ...
    check=models.TextField(default="absent")        #for secondary purposes while sharing response with frontend does not in any way affect what is stored in database and need not be changed
