...
def create_new_session(request):
    ...
    ins=session_record_table(course_name=request.data['course_name'], date=request.data['date'] ,start_time=request.data['start_time'],end_time=request.data['end_time'],location=request.data['coords'])
    ins.save()
...
@api_view(['POST'])
def show_sessions_teacher(request):
    ...
    session_records = list(session_record_table.objects.filter(course_name=request.data['course_name']))
